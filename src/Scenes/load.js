class Load extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("s", "keyboard_s.png");
        this.load.image("duck_yellow", "duck_yellow.png");
        this.load.image("duck_green", "duck_brown.png");
        this.load.image("duck_back", "duck_back.png");
    }
    create() {
