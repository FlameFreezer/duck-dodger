...
const PLAYER_FIRE_RATE_PER_LEVEL = 50; //fire rate to subtract from delay per level of upgrade (ms)
const PLAYER_FIRE_RATE_PER_PROJECTILES_LEVEL = 20; //fire rate to add to delay per level of upgrade (ms)
const PLAYER_MAX_FIRE_RATE = 10; //min delay between player shots (ms)
...
const PLAYER_ACCELERATION = PLAYER_BASE_SPEED / 0.085;
...
const BREAD_SPAWN_TIME = 1500;

const TUTORIAL_INTRO_PHASE_TIME = 4000;
